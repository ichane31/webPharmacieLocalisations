...
export default function Home() {
  ...
  const loadlists = async () => {
    const result = await axios.get("http://localhost:8080/factureswater");
  ...
  return (
    ...
    <div className="container">
      <div className="">
          ...
          <div class="col-12">
          <Link className="btn btn-outline-warning" to="/paywater">
            pay for a bill 
      </Link>
      <Link className="btn btn-outline-warning" to="/listfactureswaterexpire">
           Expired bill
      </Link>
            ...
            {listes.map((liste, index) => (
              <tr>
                ...
                <button
                    ...
                    onClick={() => deleteFacture(liste.id)}
